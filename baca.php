...
<head>
    ...
    <title>Baca</title>
    <style> /* Tambahkan gaya untuk efek blur */ .modal-backdrop { backdrop-filter: blur(5px); -webkit-backdrop-filter: blur(5px); } </style>
</head>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav nav-underline">
                    ...
                    <?php
                    $level = isset($_SESSION['user']) && $_SESSION['user'] == 'writter';
                    if ($level) {
                    ?>
                        <li class="nav-item">
                    ...
                    <?php
                    $level = isset($_SESSION['user']) && $_SESSION['user'] == 'admin';
                    if ($level) {
                    ?>
                        <li class="nav-item">
